...
.     ----[ Evacuate database ]----
-----------------------------------------
curl -sSX DELETE "http://aHost:8182/graphs/neo4jsample"
{
...
-----------------------------------------
curl -gsX POST "http://aHost:8182/graphs/neo4jsample/indices/vertices?class=vertex&type=automatic&keys=[ID]"
{
    "version": "0.4-SNAPSHOT",
    "queryTime": 13.161729,
    "results": {
...
.      ----[ List indices ]----
-----------------------------------------
curl -sX GET "http://aHost:8182/graphs/neo4jsample/indices"
{
    "version": "0.4-SNAPSHOT",
    "results": [
        {
...
.      ----[ Create deck ]----
-----------------------------------------
curl -sd "ID=5&Type=Pack&Name=Deck of Cards" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 137,
...
.      ----[ Create suits ]----
-----------------------------------------
curl -sd "ID=101&Type=Suit&Name=Diamond" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 138,
...
bc. curl -sd "ID=202&Type=Suit&Name=Heart" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 139,
...
bc. curl -sd "ID=303&Type=Suit&Name=Spade" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 140,
...
bc. curl -sd "ID=404&Type=Suit&Name=Club" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 141,
...
.       ----[ Create aces ]----
-----------------------------------------
curl -sd "ID=1&Type=Card&Name=Ace" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 142,
...
bc. curl -sd "ID=14&Type=Card&Name=Ace" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 143,
...
bc. curl -sd "ID=27&Type=Card&Name=Ace" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 144,
...
bc. curl -sd "ID=40&Type=Card&Name=Ace" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 145,
...
.      ----[ Create kings ]----
-----------------------------------------
curl -sd "ID=13&Type=Card&Name=King" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 146,
...
bc. curl -sd "ID=26&Type=Card&Name=King" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 147,
...
bc. curl -sd "ID=39&Type=Card&Name=King" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 148,
...
bc. curl -sd "ID=52&Type=Card&Name=King" "http://aHost:8182/graphs/neo4jsample/vertices/"
{
    "version": "0.4-SNAPSHOT",
    "results": {
        "_id": 149,
...
.   ----[ Check an Ace vertex ]----
-----------------------------------------
curl -sX GET "http://aHost:8182/graphs/neo4jsample/indices/vertices?key=ID&value=40"
{
    "version": "0.4-SNAPSHOT",
    "results": [
        {
...
-----------------------------------------
       ----[ Test connection ]----
-----------------------------------------
Got request status 200 from http://aHost:8182/graphs/neo4jsample/
-----------------------------------------
      ----[ Evacuate database ]----
-----------------------------------------
